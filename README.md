...
To start using the bootstrap-datetimepicker plugin in your rails application, enable it via the asset pipeline. You will need to **restart the rails server** after installing the gems before this will work.
